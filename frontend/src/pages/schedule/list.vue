                        ...
                        <div  class="col-12 md:col-3 " >
                            <template v-if="auth.canView('/schedule/add')">
                                <router-link :to="`/schedule/add`">
                                    <Button label="Agregar nuevo horario" icon="pi pi-plus" type="button" class="p-button bg-primary "  />
                                </router-link>
                            </template>
                        </div>
                            ...
                            <div class="page-records"  >
                                <DataTable :lazy="true"   :loading="loading"    v-model:selection="selectedItems"
                                    ...
                                    <Column selectionMode="multiple" headerStyle="width: 2rem" />
                                        ...
                                        <Column  field="classes_name" header="Nombre de la clase" >
                                            <template #body="{data}">
                                                {{ data.classes_name }}
                                            </template>
                                        </Column>
                                        <Column  field="schedule_name_label" header="Nombre del horario" >
                                            <template #body="{data}">
