                ...
                <div class="container">
                    <div class="grid ">
                        <div  class="col comp-grid" >
                            <div class="">
                                <div class="">
                                    <AssistanceListPage ref="assistanceListPage"  :limit="10" field-name="user.password" :show-header="true" :show-breadcrumbs="true" :show-footer="true" :paginate="true" page-store-key="INDEX-ASSISTANCE" is-sub-page>
                                        </AssistanceListPage>
                                    </div>
                                </div>
                            </div>
...
<script setup>
	...
	const props = defineProps({
		...
		pageStoreKey: {
			type: String,
			default: 'ASSISTANCE-ALUMNOS_RESER',
		},
		pageName: {
			type: String,
			default: 'assistance',
		...
		routeName: {
			type: String,
			default: 'assistancealumnos_reser',
		},
		apiPath: {
			type: String,
			default: 'assistance/alumnos_reser',
