                            ...
                            <div >
                                <div class="mb-3 grid justify-content-start">
                                    <div class="col-12 md:col-4">
                                        <div class="card flex gap-3 align-items-center p-3 ">
                                            <div class="">
                                                ...
                                                <div class="font-bold">
                                                    <image-viewer image-size="large" image-preview-size="" :src="item.banner" width="auto" height="auto" class="img-fluid" :num-display="1">
                                                    </image-viewer>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12 md:col-4">
                                        <div class="card flex gap-3 align-items-center p-3 ">
                                            <div class="">
                                                <div class="text-400 font-medium mb-1">Email maestro</div>
...
<script setup>
	...
	onMounted(()=>{ 
		const pageTitle = "Detalles clase";
