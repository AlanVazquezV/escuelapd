                                    ...
                                    <div class="grid">
                                        ...
                                        <div class="col-12">
                                            <div class="formgrid grid">
                                                ...
                                                <div class="col-12 md:col-9">
                                                    ...
                                                    <InputText  ref="ctrlemail" @blur="checker.check" :loading="checker.loading" v-model.trim="formData.email"  label="Email" type="email" placeholder="Ingrese un email"      
                                        ...
                                        <div class="col-12">
                                            <div class="formgrid grid">
                                                ...
                                                <div class="col-12 md:col-9">
                                                    <Password ref="ctrlpassword" v-model="formData.password" label="Contraseña" placeholder="Ingrese contraseña"   
...
<script setup>
	...
	const props = defineProps({
		...
		msgAfterSave: {
			type: String,
			default: "Se ha agregado correctamente",
		},
		msgBeforeSave: {
			type: String,
			default: "",
	...
	onMounted(()=>{
		const pageTitle = "Agregar nuevo usuario";
