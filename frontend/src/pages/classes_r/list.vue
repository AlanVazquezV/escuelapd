                        ...
                        <div  class="col-12 md:col-3 " >
                            <template v-if="auth.canView('/classes_r/add')">
                                <router-link :to="`/classes_r/add`">
                                    <Button label="Agregar una clase de reserva" icon="pi pi-plus" type="button" class="p-button bg-primary "  />
                                </router-link>
                            </template>
                        </div>
                        ...
                        <div >
                            ...
                            <div class="page-records"  >
                                <DataTable :lazy="true"   :loading="loading"     :value="records" dataKey="id" @sort="onSort($event)" class="" :showGridlines="false" :rowHover="true" responsiveLayout="stack">
                                    ...
                                    <Column  field="classes_name" header="Clase" >
                                        <template #body="{data}">
                                            {{ data.classes_name }}
                                        </template>
                                    </Column>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'classes_rlist',
		},
		apiPath: {
			type: String,
			default: 'classes_r/index',
		},
		paginate: {
			type: Boolean,
			default: true,
	...
	onMounted(()=>{ 
		const pageTitle = "Clases para reservar";
