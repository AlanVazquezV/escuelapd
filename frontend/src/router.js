...
//assistance routes
			...
			{
				path: '/assistance/list_assis_2/:index?/:fieldName?/:fieldValue?',
				name: 'assistancelist_assis_2',
				component: () => import('./pages/assistance/list_assis_2.vue'), 
				props: true
			},
			
	
			{ 
				path: '/assistance/asiss_reserv/:id', 
				name: 'assistanceasiss_reserv', 
				component: () => import('./pages/assistance/asiss_reserv.vue'), 
				props: true
			},
		
			{ 
				path: '/assistance/asiss_lista/:id', 
				name: 'assistanceasiss_lista', 
				component: () => import('./pages/assistance/asiss_lista.vue'), 
				props: true
			},
		
			{ 
				path: '/assistance/confirmar/:id', 
				name: 'assistanceconfirmar', 
				component: () => import('./pages/assistance/confirmar.vue'), 
				props: true
			},
		
			{ 
				path: '/assistance/alumnos_reser/:id', 
				name: 'assistancealumnos_reser', 
				component: () => import('./pages/assistance/alumnos_reser.vue'), 
				props: true
			},
...
//classes routes
			...
			{
				path: '/classes/list_usuario/:index?/:fieldName?/:fieldValue?',
				name: 'classeslist_usuario',
				component: () => import('./pages/classes/list_usuario.vue'), 
				props: true
			},
			
	
			{ 
				path: '/classes/alumnos_listi/:id', 
				name: 'classesalumnos_listi', 
				component: () => import('./pages/classes/alumnos_listi.vue'), 
				props: true
			},
...
//classes_r routes
			{
				path: '/classes_r/:index?/:fieldName?/:fieldValue?',
				name: 'classes_rlist',
				component: () => import('./pages/classes_r/list.vue'), 
				props: true
			},
			
	
			{ 
				path: '/classes_r/view/:id', 
				name: 'classes_rview', 
				component: () => import('./pages/classes_r/view.vue'), 
				props: true
			},
			...
			{ 
				path: '/classes_r/add', 
				name: 'classes_radd', 
				component: () => import('./pages/classes_r/add.vue'), 
				props: true
			},
	
			{ 
				path: '/classes_r/edit/:id', 
				name: 'classes_redit', 
				component: () => import('./pages/classes_r/edit.vue'), 
				props: true
			},
		
			{ 
				path: '/classes_r/clases_list/:id', 
				name: 'classes_rclases_list', 
				component: () => import('./pages/classes_r/clases_list.vue'), 
				props: true
			},
		
			{ 
				path: '/classes_r/clases_reservas/:id', 
				name: 'classes_rclases_reservas', 
				component: () => import('./pages/classes_r/clases_reservas.vue'), 
				props: true
			},
		
			{
				path: '/classes_r/clases_r_lista_admin/:index?/:fieldName?/:fieldValue?',
				name: 'classes_rclases_r_lista_admin',
				component: () => import('./pages/classes_r/clases_r_lista_admin.vue'), 
				props: true
			},
...
//user routes
			...
			{
				path: '/user/alumnos_lista/:index?/:fieldName?/:fieldValue?',
				name: 'useralumnos_lista',
				component: () => import('./pages/user/alumnos_lista.vue'), 
				props: true
			},
