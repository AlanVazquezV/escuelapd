...
class User extends Authenticatable 
{
     ...
     * @var array
     */
	protected $fillable = ["name","lastname","type","username","status","schedule","mobile","image","cycle","email","password"];
	/**
	...
	/**
     * return alumnosLista page fields of the model.
     * 
     * @return array
     */
	public static function alumnosListaFields(){
		return [ 
			"user.name AS name", 
			"user.lastname AS lastname", 
			"user.username AS username", 
	...
	/**
     * return exportAlumnosLista page fields of the model.
     * 
     * @return array
     */
	public static function exportAlumnosListaFields(){
		return [ 
			"user.name AS name", 
			"user.lastname AS lastname", 
			"user.username AS username", 
