...
/* routes for Assistance Controller  */	
	...
	Route::get('assistance/list_assis_2', 'AssistanceController@list_assis_2');
	Route::get('assistance/list_assis_2/{filter?}/{filtervalue?}', 'AssistanceController@list_assis_2');	
	Route::get('assistance/asiss_reserv/{rec_id}', 'AssistanceController@asiss_reserv');	
	Route::get('assistance/asiss_lista/{rec_id}', 'AssistanceController@asiss_lista');	
	Route::any('assistance/confirmar/{rec_id}', 'AssistanceController@confirmar');	
	Route::get('assistance/alumnos_reser/{rec_id}', 'AssistanceController@alumnos_reser');
...
/* routes for Classes Controller  */	
	...
	Route::get('classes/list_usuario', 'ClassesController@list_usuario');
	Route::get('classes/list_usuario/{filter?}/{filtervalue?}', 'ClassesController@list_usuario');	
	Route::get('classes/alumnos_listi/{rec_id}', 'ClassesController@alumnos_listi');
...
/* routes for Classes_R Controller  */	
	Route::get('classes_r', 'Classes_RController@index');
	Route::get('classes_r/index', 'Classes_RController@index');
	Route::get('classes_r/index/{filter?}/{filtervalue?}', 'Classes_RController@index');	
	Route::get('classes_r/view/{rec_id}', 'Classes_RController@view');	
	Route::post('classes_r/add', 'Classes_RController@add');	
	Route::any('classes_r/edit/{rec_id}', 'Classes_RController@edit');	
	Route::any('classes_r/delete/{rec_id}', 'Classes_RController@delete');	
	Route::get('classes_r/clases_list/{rec_id}', 'Classes_RController@clases_list');	
	Route::get('classes_r/clases_reservas/{rec_id}', 'Classes_RController@clases_reservas');	
	Route::get('classes_r/clases_r_lista_admin', 'Classes_RController@clases_r_lista_admin');
	Route::get('classes_r/clases_r_lista_admin/{filter?}/{filtervalue?}', 'Classes_RController@clases_r_lista_admin');
...
/* routes for User Controller  */	
	...
	Route::get('user/alumnos_lista', 'UserController@alumnos_lista');
	Route::get('user/alumnos_lista/{filter?}/{filtervalue?}', 'UserController@alumnos_lista');
...
Route::get('home', 'HomeController@index');
	...
	Route::get('components_data/classes_r_option_list/{arg1?}', 'Components_dataController@classes_r_option_list');	
	...
	Route::get('components_data/user_name_exist/{arg1?}', 'Components_dataController@user_name_exist');	
